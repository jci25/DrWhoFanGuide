...
public class CharacterFragment extends BaseFragment implements OnQueryTextListener{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        season = bundle.getString("desc", "Unknown");
        title_id = bundle.getString("season", "Error");
        getActivity().setTitle(season);
        try{
    ...
    public void onResume(){
	 ...
	 private class initCards extends AsyncTask<Void, Void, ArrayList<String[]>> {
		 ...
		 protected CharacterFragment ef;
		 
		 protected initCards(CharacterFragment ef){
			 this.ef = ef;
		 }
		 ...
		 @Override
			protected void onPostExecute(ArrayList<String[]> result) {
			 ...
			 for (int i=0;i<itemsList.size();i++){
		            EpisodeCard card = new EpisodeCard(getActivity(),itemsList.get(i)[0],itemsList.get(i)[1],itemsList.get(i)[2],itemsList.get(i)[3],itemsList.get(i)[4], itemsList.get(i)[2], getActivity());
		            cards.add(card);
		        }
			...
			protected ArrayList<String[]> doInBackground(Void... arg0) {
				...
				ArrayList<String[]> itemsList = sc.getCharactersByTitle(title_id);
