...
import com.drexel.cs451.dr.who.SeasonFragment;
...
public class SeasonCardLoad extends Card{

    protected Context context;
    protected SeasonFragment af;
    protected int count, pos;
    //protected Activity act;

    public SeasonCardLoad(Context context, SeasonFragment seasonFragment, int count, int pos) {
        super(context, R.layout.card_announce_load);
        //this.act=activity;
        this.context = context;
        this.af = seasonFragment;
        this.count = count;
        this.pos = pos;
        init();
    }
