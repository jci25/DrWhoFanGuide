...
import com.drexel.cs451.dr.who.AnnounceFragment;
...
public class AnnounceCardLoad extends Card{
    ...
    public AnnounceCardLoad(Context context, AnnounceFragment af, int count, int pos) {
